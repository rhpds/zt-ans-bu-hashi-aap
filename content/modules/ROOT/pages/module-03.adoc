...
[NOTE]
====
The GitHub OAuth connection to Terraform Enterprise has been pre-configured for you in this lab.
If you do not have a GitHub account, you can skip Tasks 1 and 2 and proceed directly to xref:module-03.adoc#task3[Task 3].
====

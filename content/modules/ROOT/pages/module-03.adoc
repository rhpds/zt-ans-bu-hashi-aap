...
* Click on the `Authentication` menu option in the left menu.
* Click on the `AppRole` menu option.
...
image::vaultapprole1.png[]

* Click on the `Role ID` button.
* Copy the Role ID to your clipboard.

image::vaultapprole2.png[]

* Click on the `Secret ID` button.
...
| tfe-https.{dns_domain}  **<Your terraform hostname url>** # This will look like: https://tfe-https-12345-a.apps.#######.rhdp.net

| TEST TEST TESTExample
| tfe-https-{guid}-1.{dns_domain}
